...
interface YouTubeVideoCardSuggestedCourseProps {
  course: Course;
  completed: boolean;
  themeColor: string;
  educators: string[];
...
const YouTubeVideoCardSuggestedCourse: React.FC<YouTubeVideoCardSuggestedCourseProps> = ({
  themeColor,
  completed,
  course,
  educators,
  ...
  console.log("mihai YouTubeVideoCardSuggestedCourse scheduledreleasedate is: ", courseMetadata?.scheduledreleasedate || "");
  console.log("mihai YouTubeVideoCardSuggestedCourse formattedLaunchDate is: ", formattedLaunchDate);
  console.log("mihai YouTubeVideoCardSuggestedCourse formattedTime is: ", formattedTime);
  ...
  const onUserClick = () => {
    ...
    (window as any).dataLayer.push({
      event: "clickedSuggestedCourse",

      onPageOfCourse: courseId.toString(),
      userDataId: userDataBaseId,

      clickedSuggestedCourseId: databaseId,
      clickedSuggestedCourseName: title,
...
export default YouTubeVideoCardSuggestedCourse;
