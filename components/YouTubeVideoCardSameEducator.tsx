...
interface YouTubeVideoCardSameEducatorProps {
  course: Course;
  completed: boolean;
  themeColor: string;
  educators: string[];
...
const YouTubeVideoCardSameEducator: React.FC<YouTubeVideoCardSameEducatorProps> = ({
  themeColor,
  completed,
  course,
  educators,
  ...
  const onUserClick = () => {
    ...
    (window as any).dataLayer.push({
      event: "clickedMoreCoursesFromEducator",
...
export default YouTubeVideoCardSameEducator;
