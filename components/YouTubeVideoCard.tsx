...
const YouTubeVideoCard: React.FC<YouTubeVideoCardProps> = ({
	...
	const { title, courseMetadata, slug, categories } = course;
	const pictureUrl =
	...
	console.log(
		"mihai YouTubeVideoCard scheduledreleasedate is: ",
		courseMetadata?.scheduledreleasedate || ""
	);
	console.log(
		"mihai YouTubeVideoCard formattedLaunchDate is: ",
		formattedLaunchDate
	);
	console.log("mihai YouTubeVideoCard formattedTime is: ", formattedTime);
	...
	return (
		<div
			className={`self-start p-4 min-w-[327px] w-full md:w-[370px] ${classname}`}
		>
