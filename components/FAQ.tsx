...
const FAQ: React.FC = () => {
  ...
  const accordionSections = [
    ...
    },
    {
      ...
      content1:
        "YES! All of your courses on BTCUniversity.com will be added to both your profile and the course category pages where you have unlimited access. Take your classes on your time at your own pace.",
      content2: "",
      content1href: "",
      content2href: "",
      category: "course-questions",
    ...
    },
    {
      ...
      content1:
        "Once you start a course, it will be added to your profile  and if you do not finish the course, you can find it under ‘Continue Your Courses.’ You will have unlimited access as long as the class remains on BTCUniversity.com and you are a subscriber.",
      content2: "",
      content1href: "",
      content2href: "",
      category: "course-questions",
    ...
    { id: 10, title: "Can I take notes in my course?", content1: "Yes. There is a ‘Take Notes’ button below each course. There you are able to take and save notes, which are available for as long as you have access to the course.", content2: "", content1href: "", content2href: "", category: "course-questions" },
    { id: 11, title: "Can I download course materials?", content1: "Yes. If there are downloadables, you will see these in the course page under ‘Downloadables.’ You can download these by simply clicking on the button.", content2: "", content1href: "", content2href: "", category: "course-questions" },
    { id: 12, title: "How do I contact the instructor?", content1: "All of our courses show the educator(s) and their Instagram handle(s). You can simply follow them on Instagram and message them with questions you may have about the techniques or products used in the video.", content2: "", content1href: "", content2href: "", category: "course-questions" },
    { id: 13, title: "Can I take more than one course at a time?", content1: "There is no limit to the number of courses that can be taken at any given time.", content2: "", content1href: "", content2href: "", category: "course-questions" },
    { id: 14, title: "Do I have to be online at a specific time?", content1: "No. Your online courses are available around the clock, which means that you can log in at any time, day or night, and take your course.", content2: "", content1href: "", content2href: "", category: "course-questions" },
    { id: 15, title: "I can't watch my course during the time it premieres, can I watch it at a later time?", content1: "YES! All of your courses on BTCUniversity.com will be added to both your profile and the course category pages where you have unlimited access. Take your classes on your time at your own pace.", content2: "", content1href: "", content2href: "", category: "course-questions" },
    { id: 16, title: "Where can I find the formulas for color courses?", content1: "Color courses will have any formula information located under ‘Formulas’ directly under the video. You must be a subscriber to access formula information.", content2: "", content1href: "", content2href: "", category: "course-questions" },
    { id: 17, title: "Do these courses count toward my CE hours?", content1: "At this time, BTC-U courses are not offered as CE hours, as each state has different regulations. However, we recommend that you contact your state board to find out if they will accept our courses to gain CE hours.", content2: "", content1href: "", content2href: "", category: "course-questions" },
    { id: 18, title: "Where can I find my certificates?", content1: "To easily access all certificates granted, Click .", content2: "HERE", content1href: "", content2href: "/profile?q=certificates", category: "course-questions" },
    { id: 19, title: "How long will I have to watch a course?", content1: "Once you start a course, it will be added to your profile  and if you do not finish the course, you can find it under ‘Continue Your Courses.’ You will have unlimited access as long as the class remains on BTCUniversity.com and you are a subscriber.", content2: "", content1href: "", content2href: "", category: "course-questions" },
    { id: 20, title: "When do new courses get added?", content1: "Similar to other subscriptions, new classes will be added monthly. Don’t worry, we'll be sure to email you with updates!", content2: "Don’t forget to follow @btcuniversity on Instagram to stay updated and enjoy more education from the industry’s top educators!", content1href: "", content2href: "", category: "course-questions" },
    { id: 21, title: "Do courses get removed?", content1: "Courses are sometimes archived, but it is rare. If you completed a course that is now archived, your certificate will remain on your account–you do not lose it. ", content2: "", content1href: "", content2href: "", category: "course-questions" },
    { id: 22, title: "Subtitles and languages", content1: "Our courses are spoken in English with numerous courses offering subtitles in English, Spanish, Italian, French, Portuguese and Russian.", content2: "Click HERE to view the courses we currently offer with subtitles.", content1href: "", content2href: "/languages", category: "course-questions" },
    { id: 23, title: "What forms of payments do you accept?", content1: "We accept all major credit cards.", content2: "", content1href: "/profile", content2href: "", category: "payment-and-cancellations" },
    { id: 24, title: "Expired credit cards", content1: "Credit cards can become inactive for a number of reasons including card expiration, inactivation, etc. If you are aware that the credit card we have on file is out of date or no longer valid, please update your credit card details or else you may lose access to your account. To update, log into your account and click the 'Account' icon at the top . You will be directed to your account  page. From here, select ‘Edit Payment Info’ and add your new payment method.", content2: "", content1href: "/profile", content2href: "", category: "payment-and-cancellations" },
    { id: 25, title: "Can I cancel anytime?", content1: "Yes. You may cancel your subscription at any time, but if you cancel your subscription before the end of the current subscription period, we will not refund any subscription fees already paid to us. Following any cancellation, however, you will continue to have access to the service through the end of your current subscription period. Payments are non-refundable and there are no refunds or credits issued for partially used periods.", content2: "", content1href: "", content2href: "", category: "payment-and-cancellations" },
    { id: 26, title: "Will my subscription automatically renew?", content1: "Yes. Subscriptions automatically renew each year on their anniversary date for annual subscriptions, each month on their anniversary date for monthly subscriptions and each 6-month period on their anniversary date for 6-month subscriptions.", content2: "", content1href: "", content2href: "", category: "payment-and-cancellations" },
    { id: 27, title: "Can I take my courses on my smartphone or tablet?", content1: "Yes, our courses are fully HTML5 compatible which means you can experience each course on your smartphone or tablet. Layouts, scrolling or displays may vary depending on the device you have.", content2: "", content1href: "", content2href: "", category: "troubleshooting" },
    { id: 28, title: "What browsers are supported?", content1: "We support the current and the previous major release(s) of Chrome, Firefox, Safari, and Microsoft browsers. This currently includes Microsoft Edge and Internet Explorer. Each time a new browser version is released, we begin supporting that version and stop supporting the third most recent version.", content2: "", content1href: "", content2href: "", category: "troubleshooting" },
    { id: 29, title: "Troubleshooting audio issues", content1: "If you are experiencing audio issues, we recommend you check your internet connection. If necessary, you may need to reset your internet connection, clear your cache, update your browser or try a different one. Additionally, check your speaker/headphone connection and your audio system preferences.", content2: "", content1href: "", content2href: "", category: "troubleshooting" },
    { id: 30, title: "Troubleshooting video issues", content1: "If you are having problems viewing a video, we recommend you check your internet connection. If necessary, reset your internet connection, clear your cache, update your browser or try another browser.", content2: "", content1href: "", content2href: "", category: "troubleshooting" }
  ];
  ...
  return (
    <div className="mb-4 max-w-[570px] mx-auto">
