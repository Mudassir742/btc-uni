...
interface YouTubeVideoCardUpcomingProps {
  course: Course;
  themeColor: string;
  educators: string[];
...
const YouTubeVideoCardUpcoming: React.FC<YouTubeVideoCardUpcomingProps> = ({
  themeColor,
  course,
  educators,
  ...
  // const preFormattedDate = formatDate(courseMetadata?.scheduledreleasedate || "");
  ...
  console.log("mihai YouTubeVideoCardUpcoming scheduledreleasedate is: ", courseMetadata?.scheduledreleasedate || "");
  console.log("mihai YouTubeVideoCardUpcoming formattedLaunchDate is: ", formattedLaunchDate);
  console.log("mihai YouTubeVideoCardUpcoming formattedTime is: ", formattedTime);
  ...
  return (
    <div className={`p-4 min-w-[327px] w-full md:w-[370px] bg-${backgroundColor}`} >
          ...
          <div className="relative">
            ...
            {vimeoPromoId !== "" && (
              <>
                ...
                <Link href={`/courses/${slug}`} className="absolute inset-0 z-10" />
              </>
            )}
            {vimeoPromoId === "" && (
...
export default YouTubeVideoCardUpcoming;
