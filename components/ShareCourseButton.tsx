...
const ShareCourseButton: React.FC<ShareCourseButtonProps> = ({
	courseId,
	userDataBaseId,
	shareText,
	shareImg,
	...
	return (
		<div className="px-2 ">
			{/* Mobile */}
			<div className="md:hidden" onClick={() => shareLink(fullPageLink)}>
				<button>
			...
			<Dialog>
				...
				<DialogContent className="sm:max-w-max ">
					<DialogHeader>
						<DialogTitle className=" text-themecolor-500">Share</DialogTitle>
					</DialogHeader>
					...
					<div className="flex items-center gap-x-5 mt-5">
						...
						>
							...
							<p className="text-12 text-themecolor-500">Facebook</p>
						</FacebookShareButton>
						...
						>
							...
							<p className="text-12 text-themecolor-500">LinkedIn</p>
						</LinkedinShareButton>
						...
						>
							...
							<p className="text-12 text-themecolor-500">WhatsApp</p>
						</WhatsappShareButton>
						...
						>
							...
							<p className="text-12 text-themecolor-500">Email</p>
						</EmailShareButton>
						...
						>
							...
							<p className="text-12 text-themecolor-500">X</p>
						</TwitterShareButton>
						...
						>
							...
							<p className="text-12 text-themecolor-500">Pinterest</p>
						</PinterestShareButton>
					</div>
				</DialogContent>
			</Dialog>
