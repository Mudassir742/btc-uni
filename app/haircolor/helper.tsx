...
import {
  GET_BALAYAGE_HAIRCOLOR_COURSES,
  GET_BRUNETTES_HAIRCOLOR_COURSES,
  GET_CREATIVE_HAIRCOLOR_COURSES,
  GET_CURLS_TEXTURE_HAIRCOLOR_COURSES,
  GET_FOILING_HAIRCOLOR_COURSES,
  GET_GRAY_HAIRCOLOR_COURSES,
  GET_LOWLIGHTS_HAIRCOLOR_COURSES,
  GET_NEW_HAIRCOLOR_COURSES,
  GET_PLATINUM_BLONDES_HAIRCOLOR_COURSES,
  GET_REDS_COPPERS_HAIRCOLOR_COURSES,
  GET_ROOT_SMUDGE_HAIRCOLOR_COURSES,
  GET_TONING_HAIRCOLOR_COURSES,
} from "@/graphql/queries/haircolor";
...
export async function getCategoriesPage(): Promise<CategoriesPage> {
  const response = await fetch(process.env.NEXT_PUBLIC_WORDPRESS_API_URL!, {
    ...
    // switched "no-store" to revalidate: 2 on jan 2 BUT this is not actually in use
    body: JSON.stringify({
...
// mihai may 23 new function for querying category page metadata including metatile, metadescription and featured image
export async function getCategoryPageMetadata(params: {
  databaseId: string
}): Promise<CategoryPageMetadata> {
  const response = await fetch(process.env.NEXT_PUBLIC_WORDPRESS_API_URL!, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
...
export async function getNewHaircolorCourses(): Promise<Course[]> {
  const response = await fetch(process.env.NEXT_PUBLIC_WORDPRESS_API_URL!, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    ...
    // cache: "no-store", // we have other options, like "no-store" / no-cache will revalidate the data, with no-store it's checking with each request if there are any changes
    body: JSON.stringify({
      query: GET_NEW_HAIRCOLOR_COURSES.loc?.source.body,
    }),
  });
  ...
  const courses: Course[] = data.page.hairColorCourses.newHairColorCourses;

  return transformDataForWpUrl(courses);
}

export async function getBalayageHaircolorCourses(): Promise<Course[]> {
  const response = await fetch(process.env.NEXT_PUBLIC_WORDPRESS_API_URL!, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    ...
    // cache: "no-store", // we have other options, like "no-store" / no-cache will revalidate the data, with no-store it's checking with each request if there are any changes
    body: JSON.stringify({
      query: GET_BALAYAGE_HAIRCOLOR_COURSES.loc?.source.body,
    }),
  });
  ...
  const courses: Course[] = data.page.hairColorCourses.balayageHairColorCourses;

  return transformDataForWpUrl(courses);
}

export async function getBrunettesHaircolorCourses(): Promise<Course[]> {
  const response = await fetch(process.env.NEXT_PUBLIC_WORDPRESS_API_URL!, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    ...
    // cache: "no-store", // we have other options, like "no-store" / no-cache will revalidate the data, with no-store it's checking with each request if there are any changes
    body: JSON.stringify({
      query: GET_BRUNETTES_HAIRCOLOR_COURSES.loc?.source.body,
    }),
  });
  ...
  const courses: Course[] =
    data.page.hairColorCourses.brunettesHairColorCourses;

  return transformDataForWpUrl(courses);
}

export async function getCreativeHaircolorCourses(): Promise<Course[]> {
  const response = await fetch(process.env.NEXT_PUBLIC_WORDPRESS_API_URL!, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    ...
    // cache: "no-store", // we have other options, like "no-store" / no-cache will revalidate the data, with no-store it's checking with each request if there are any changes
    body: JSON.stringify({
      query: GET_CREATIVE_HAIRCOLOR_COURSES.loc?.source.body,
    }),
  });
  ...
  const courses: Course[] =
    data.page.hairColorCourses.creativeColorHairColorCourses;

  return transformDataForWpUrl(courses);
}

export async function getCurlsTextureHaircolorCourses(): Promise<Course[]> {
  const response = await fetch(process.env.NEXT_PUBLIC_WORDPRESS_API_URL!, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    ...
    // cache: "no-store", // we have other options, like "no-store" / no-cache will revalidate the data, with no-store it's checking with each request if there are any changes
    body: JSON.stringify({
      query: GET_CURLS_TEXTURE_HAIRCOLOR_COURSES.loc?.source.body,
    }),
  });
  ...
  const courses: Course[] =
    data.page.hairColorCourses.curlsAndTextureHairColorCourses;

  return transformDataForWpUrl(courses);
}

export async function getFoilingHaircolorCourses(): Promise<Course[]> {
  const response = await fetch(process.env.NEXT_PUBLIC_WORDPRESS_API_URL!, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    ...
    // cache: "no-store", // we have other options, like "no-store" / no-cache will revalidate the data, with no-store it's checking with each request if there are any changes
    body: JSON.stringify({
      query: GET_FOILING_HAIRCOLOR_COURSES.loc?.source.body,
    }),
  });
  ...
  const courses: Course[] = data.page.hairColorCourses.foilingHairColorCourses;

  return transformDataForWpUrl(courses);
}

export async function getGrayHaircolorCourses(): Promise<Course[]> {
  const response = await fetch(process.env.NEXT_PUBLIC_WORDPRESS_API_URL!, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    ...
    // cache: "no-store", // we have other options, like "no-store" / no-cache will revalidate the data, with no-store it's checking with each request if there are any changes
    body: JSON.stringify({
      query: GET_GRAY_HAIRCOLOR_COURSES.loc?.source.body,
    }),
  });
  ...
  const courses: Course[] =
    data.page.hairColorCourses.grayCoverageHairColorCourses;

  return transformDataForWpUrl(courses);
}

export async function getLowlightsHaircolorCourses(): Promise<Course[]> {
  const response = await fetch(process.env.NEXT_PUBLIC_WORDPRESS_API_URL!, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    ...
    // cache: "no-store", // we have other options, like "no-store" / no-cache will revalidate the data, with no-store it's checking with each request if there are any changes
    body: JSON.stringify({
      query: GET_LOWLIGHTS_HAIRCOLOR_COURSES.loc?.source.body,
    }),
  });
  ...
  const courses: Course[] =
    data.page.hairColorCourses.lowlightsHairColorCourses;

  return transformDataForWpUrl(courses);
}

export async function getPlatinumBlondesHaircolorCourses(): Promise<Course[]> {
  const response = await fetch(process.env.NEXT_PUBLIC_WORDPRESS_API_URL!, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    ...
    // cache: "no-store", // we have other options, like "no-store" / no-cache will revalidate the data, with no-store it's checking with each request if there are any changes
    body: JSON.stringify({
      query: GET_PLATINUM_BLONDES_HAIRCOLOR_COURSES.loc?.source.body,
    }),
  });
  ...
  const courses: Course[] =
    data.page.hairColorCourses.platinumBlondesHairColorCourses;

  return transformDataForWpUrl(courses);
}

export async function getRedsCoppersHaircolorCourses(): Promise<Course[]> {
  const response = await fetch(process.env.NEXT_PUBLIC_WORDPRESS_API_URL!, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    ...
    // cache: "no-store", // we have other options, like "no-store" / no-cache will revalidate the data, with no-store it's checking with each request if there are any changes
    body: JSON.stringify({
      query: GET_REDS_COPPERS_HAIRCOLOR_COURSES.loc?.source.body,
    }),
  });
  ...
  const courses: Course[] =
    data.page.hairColorCourses.redsAndCoppersHairColorCourses;

  return transformDataForWpUrl(courses);
}

export async function getRootSmudgeHaircolorCourses(): Promise<Course[]> {
  const response = await fetch(process.env.NEXT_PUBLIC_WORDPRESS_API_URL!, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    ...
    // cache: "no-store", // we have other options, like "no-store" / no-cache will revalidate the data, with no-store it's checking with each request if there are any changes
    body: JSON.stringify({
      query: GET_ROOT_SMUDGE_HAIRCOLOR_COURSES.loc?.source.body,
    }),
  });
  ...
  const courses: Course[] =
    data.page.hairColorCourses.rootSmudgeHairColorCourses;

  return transformDataForWpUrl(courses);
}

export async function getToningHaircolorCourses(): Promise<Course[]> {
  const response = await fetch(process.env.NEXT_PUBLIC_WORDPRESS_API_URL!, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    ...
    // cache: "no-store", // we have other options, like "no-store" / no-cache will revalidate the data, with no-store it's checking with each request if there are any changes
    body: JSON.stringify({
      query: GET_TONING_HAIRCOLOR_COURSES.loc?.source.body,
    }),
  });
  ...
  const courses: Course[] =
    data.page.hairColorCourses.toningTechniquesHairColorCourses;
...
export function filterAndSortCourses(courses: Course[]): Course[] {
  ...
  const filteredAndSortedCourses: Course[] = courses
    ...
    .sort((courseA: Course, courseB: Course) => {
      const importanceA: number =
        courseA?.courseMetadata?.courseImportance || 9999; // if no course importance number added, it will give it a very large number so it goes to the end of the list
      const importanceB: number =
        courseB?.courseMetadata?.courseImportance || 9999;
