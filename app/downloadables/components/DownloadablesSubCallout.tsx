...
interface DownloadablesSubCalloutProps {
  user: UserSession | null;
}

const DownloadablesSubCallout: React.FC<DownloadablesSubCalloutProps> = async ({user}) => {
...
export default DownloadablesSubCallout;