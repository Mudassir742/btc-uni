...
interface MensDownloadablesProps {
  user: UserSession | null;
  heroTitle: string;
}

const MensDownloadables: React.FC<MensDownloadablesProps> = async ({heroTitle, user}) => {

    // check if user is logged in
    const isLoggedIn = (user?.userDataId || 0) > 0;

    const downloadableCategoryDataPromise = getCategoryPageDownloadables("433289");
    ...
    return (
        <div>
          ...
          <div id="Downloadables-Mens-section">
...
export default MensDownloadables;