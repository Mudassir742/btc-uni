...
interface StylingDownloadablesProps {
  user: UserSession | null;
  heroTitle: string;
}

const StylingDownloadables: React.FC<StylingDownloadablesProps> = async ({heroTitle, user}) => {
    ...
    return (
        <div>
          ...
          <div id="Downloadables-Styling-section">
...
export default StylingDownloadables;