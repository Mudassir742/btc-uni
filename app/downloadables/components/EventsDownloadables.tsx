...
interface EventsDownloadablesProps {
  user: UserSession | null;
  heroTitle: string;
}

const EventsDownloadables: React.FC<EventsDownloadablesProps> = async ({heroTitle, user}) => {

    // check if user is logged in
    const isLoggedIn = (user?.userDataId || 0) > 0;

    const downloadableCategoryDataPromise = getCategoryPageDownloadables("433291");
...
export default EventsDownloadables;