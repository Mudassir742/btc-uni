...
interface HaircolorDownloadablesProps {
  user: UserSession | null;
  heroTitle: string;
}

const HaircolorDownloadables: React.FC<HaircolorDownloadablesProps> = async ({heroTitle, user}) => {

    // check if user is logged in
    const isLoggedIn = (user?.userDataId || 0) > 0;

    const downloadableCategoryDataPromise = getCategoryPageDownloadables("433285");
    ...
    return (
        <div>
          ...
          <div id="Downloadables-Haircolor-section">
...
export default HaircolorDownloadables;