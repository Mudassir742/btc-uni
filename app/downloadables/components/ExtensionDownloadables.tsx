...
interface ExtensionDownloadablesProps {
  user: UserSession | null;
  heroTitle: string;
}

const ExtensionDownloadables: React.FC<ExtensionDownloadablesProps> = async ({heroTitle, user}) => {

    // check if user is logged in
    const isLoggedIn = (user?.userDataId || 0) > 0;

    const downloadableCategoryDataPromise = getCategoryPageDownloadables("433290");
    ...
    return (
        <div>
          ...
          <div id="Downloadables-Extensions-section">
...
export default ExtensionDownloadables;